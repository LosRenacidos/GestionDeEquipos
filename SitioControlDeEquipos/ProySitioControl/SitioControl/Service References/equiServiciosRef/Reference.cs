...
namespace SitioControl.equiServiciosRef {
    ...
    public partial class Equipo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string modelo_equipoField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string responsable_equipoField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string serie_equipoField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ubicacion_equipoField;
        ...
        public string modelo_equipo {
            get {
                return this.modelo_equipoField;
            }
            set {
                if ((object.ReferenceEquals(this.modelo_equipoField, value) != true)) {
                    this.modelo_equipoField = value;
                    this.RaisePropertyChanged("modelo_equipo");
                }
            }
        }
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public string responsable_equipo {
            get {
                return this.responsable_equipoField;
            }
            set {
                if ((object.ReferenceEquals(this.responsable_equipoField, value) != true)) {
                    this.responsable_equipoField = value;
                    this.RaisePropertyChanged("responsable_equipo");
                }
            }
        }
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public string ubicacion_equipo {
            get {
                return this.ubicacion_equipoField;
            }
            set {
                if ((object.ReferenceEquals(this.ubicacion_equipoField, value) != true)) {
                    this.ubicacion_equipoField = value;
                    this.RaisePropertyChanged("ubicacion_equipo");
                }
            }
        }
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="equiServiciosRef.IEquipos")]
    public interface IEquipos {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SitioControl.equiServiciosRef.RepetidoException), Action="http://tempuri.org/IEquipos/CrearEquipoRepetidoExceptionFault", Name="RepetidoException", Namespace="http://schemas.datacontract.org/2004/07/WCFServicios.Errores")]
        SitioControl.equiServiciosRef.Equipo CrearEquipo(SitioControl.equiServiciosRef.Equipo equipoACrear);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEquipos/CrearEquipo", ReplyAction="http://tempuri.org/IEquipos/CrearEquipoResponse")]
        System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo> CrearEquipoAsync(SitioControl.equiServiciosRef.Equipo equipoACrear);
        ...
        SitioControl.equiServiciosRef.Equipo ObtenerEquipo(int codigo_equipo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEquipos/ObtenerEquipo", ReplyAction="http://tempuri.org/IEquipos/ObtenerEquipoResponse")]
        System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo> ObtenerEquipoAsync(int codigo_equipo);
        ...
        SitioControl.equiServiciosRef.Equipo ModificarEquipo(SitioControl.equiServiciosRef.Equipo equipoAModificar);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEquipos/ModificarEquipo", ReplyAction="http://tempuri.org/IEquipos/ModificarEquipoResponse")]
        System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo> ModificarEquipoAsync(SitioControl.equiServiciosRef.Equipo equipoAModificar);
        ...
        SitioControl.equiServiciosRef.Equipo[] ListarEquipos();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEquipos/ListarEquipos", ReplyAction="http://tempuri.org/IEquipos/ListarEquiposResponse")]
        System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo[]> ListarEquiposAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEquiposChannel : SitioControl.equiServiciosRef.IEquipos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EquiposClient : System.ServiceModel.ClientBase<SitioControl.equiServiciosRef.IEquipos>, SitioControl.equiServiciosRef.IEquipos {
        ...
        public SitioControl.equiServiciosRef.Equipo CrearEquipo(SitioControl.equiServiciosRef.Equipo equipoACrear) {
            return base.Channel.CrearEquipo(equipoACrear);
        }
        
        public System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo> CrearEquipoAsync(SitioControl.equiServiciosRef.Equipo equipoACrear) {
            return base.Channel.CrearEquipoAsync(equipoACrear);
        }
        
        public SitioControl.equiServiciosRef.Equipo ObtenerEquipo(int codigo_equipo) {
            return base.Channel.ObtenerEquipo(codigo_equipo);
        }
        
        public System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo> ObtenerEquipoAsync(int codigo_equipo) {
            return base.Channel.ObtenerEquipoAsync(codigo_equipo);
        }
        
        public SitioControl.equiServiciosRef.Equipo ModificarEquipo(SitioControl.equiServiciosRef.Equipo equipoAModificar) {
            return base.Channel.ModificarEquipo(equipoAModificar);
        }
        
        public System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo> ModificarEquipoAsync(SitioControl.equiServiciosRef.Equipo equipoAModificar) {
        ...
        public SitioControl.equiServiciosRef.Equipo[] ListarEquipos() {
            return base.Channel.ListarEquipos();
        }
        
        public System.Threading.Tasks.Task<SitioControl.equiServiciosRef.Equipo[]> ListarEquiposAsync() {
            return base.Channel.ListarEquiposAsync();
        }

        internal void ModificarEquipo(int p)
        {
